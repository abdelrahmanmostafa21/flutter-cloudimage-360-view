import 'package:cloudimage_360_view/src/constants/enums.dart';
...
class Ci360Options {
  ...
  final Function(int index, CIImageChangedReason reason)? onImageChanged;
  ...
  Ci360Options copyWith({
    ...
    Function(int index, CIImageChangedReason reason)? onImageChanged,
  }) {
    return Ci360Options(
